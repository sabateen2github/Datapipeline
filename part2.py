...
def read():
    return pd.read_excel("C:/Users/m&a/OneDrive/Desktop/خطوط النقل.xlsx", sheet_name='Sheet1',
...
def saveResponses():
    ...
    for row in entries:
        ...
        file = open("C:/Users/m&a/OneDrive/Desktop/routes/" + row['first'] + '-' + row['second'] + ".response",
                    mode='w')
    ...
    for row in entries:
        ...
        file = open("C:/Users/m&a/OneDrive/Desktop/routes/" + row['second'] + '-' + row['first'] + ".response",
                    mode='w')
        json.dump(response, file)
        file.close()
...
def generatePaths():
    files = os.listdir('C:/Users/m&a/OneDrive/Desktop/routes')
    for name in files:
        file = open('C:/Users/m&a/OneDrive/Desktop/routes/' + name, 'r')
        contentS = file.read()
        file.close()
        content = json.loads(contentS)
        steps = content['routes'][0]['legs'][0]['steps']
        points = decodePolylineofRoute(steps)
        file = open('C:/Users/m&a/OneDrive/Desktop/paths/' + name, 'w')
