...
def dummy():
    ...
    files = os.listdir("C:/Users/m&a/OneDrive/Desktop/paths")
    for file in files:
        with open("C:/Users/m&a/OneDrive/Desktop/paths/" + file, 'r', encoding="utf-8") as f:
            path = json.load(f)
            for i in range(len(path)):
                path[i] = transformer.transform(path[i][1], path[i][0])
            with open("C:/Users/m&a/OneDrive/Desktop/paths_proj/" + file, 'w') as ff:
                json.dump(path, ff)
...
def dummy2():
    ...
    files = os.listdir("C:/Users/m&a/OneDrive/Desktop/paths_proj")
    for file in files:
        with open("C:/Users/m&a/OneDrive/Desktop/paths_proj/" + file, 'r', encoding="utf-8") as f:
            path = json.load(f)
            lineString = LineString(path).buffer(2)
            with open("C:/Users/m&a/OneDrive/Desktop/polys_proj/" + file, 'w') as pol:
                json.dump(mapping(lineString), pol)
            if file == 'وادي السير-وسط البلد.response':
                with open("C:/Users/m&a/OneDrive/Desktop/test.json", 'w') as test:
...
def dumpTest2(geometriesCollection, name="test2.json", related_data=None):
    ...
    with open("C:/Users/m&a/OneDrive/Desktop/" + name, "w") as f:
...
def dumpTest3(geometricCollection, related_data=None):
    ...
    with open("C:/Users/m&a/OneDrive/Desktop/test3.json", "w") as f:
        json.dump(features, f)
...
def generateStopPoints():
    ...
    files_polys = os.listdir("C:/Users/m&a/OneDrive/Desktop/polys_proj")
    for poly_f in files_polys:
        with open("C:/Users/m&a/OneDrive/Desktop/polys_proj/" + poly_f, "r", encoding="utf-8") as f:
    ...
    lines = []
    files_lines = os.listdir("C:/Users/m&a/OneDrive/Desktop/paths_proj")
    for line_f in files_lines:
        with open("C:/Users/m&a/OneDrive/Desktop/paths_proj/" + line_f, "r", encoding="utf-8") as f:
...
def generateSchedule():
    paths_files = os.listdir("C:/Users/m&a/OneDrive/Desktop/paths_proj")
    with open("C:/Users/m&a/OneDrive/Desktop/test3.json") as stops_file:
    ...
    for path_file in paths_files:
        with open("C:/Users/m&a/OneDrive/Desktop/paths_proj/" + path_file, "r", encoding="utf-8") as path_bin:
    ...
    for feature in features:
        del feature["pyGeo"]
    with open("C:/Users/m&a/OneDrive/Desktop/test15.json", "w") as f:
...
def lastPahse():
    ...
    transformerInv = Transformer.from_crs(crs, CRS.from_epsg(4326))
    with open("C:/Users/m&a/OneDrive/Desktop/جدول مع نقاط مع كل اشي .json") as f:
    ...
    for feature in features:
        ...
        with open("C:/Users/m&a/OneDrive/Desktop/schedules/{}.json".format(id), "w") as f:
    ...
    with open("C:/Users/m&a/OneDrive/Desktop/final_schedule.json", "w") as f:
