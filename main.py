...
if __name__ == '__masdin__':
    ...
    with open("C:/Users/m&a/OneDrive/Desktop/point_to_point/final_schedule.json") as fp:
        global features
    ...
    filesNames = os.listdir("C:/Users/m&a/OneDrive/Desktop/point_to_point/paths_proj/")
    global geoPaths
    global nameIds
    namesIds = {}
    geoPaths = []
    ...
    for fileName in filesNames:
        with open("C:/Users/m&a/OneDrive/Desktop/point_to_point/routes_ids/{}.txt".format(i), "w") as fp:
            json.dump(fileName, fp)
            namesIds[fileName] = i
        with open("C:/Users/m&a/OneDrive/Desktop/point_to_point/paths_proj/{}".format(fileName)) as fp:
    ...
    for busStop in features:
        id = busStop["id"]
        ids.append(id)
        with open("C:/Users/m&a/OneDrive/Desktop/point_to_point/schedules/{}.json".format(id), "r") as content:
    ...
    for i in range(len(busStops)):
        ...
        with open(
                "C:/Users/m&a/OneDrive/Desktop/point_to_point/generated_trees/{}.json".format(tree["node"]),
                "w") as fp:
            json.dump(tree, fp)
